...
public class SubtitleTimelineObject extends CinematicTimelineObject{
    public SubtitleTimelineObject(String name, BitmapFont fnt, TextureRegion nameTexture, TextureRegion lineTexture) {
        super(name, fnt, nameTexture, lineTexture, CinematicWidgetType.Subtitle);
    }
}
