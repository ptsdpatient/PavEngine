...
public class DynamicObject extends GameObject {
    ...
    public DynamicObject(String name, Vector3 position, float size, Scene scene, ObjectType objectType) {
        this.name = name;
    ...
    public DynamicObject(String name, Scene scene, Vector3 position, Quaternion rotation, Vector3 size, Array<PavBounds> boxes) {
        this.name = name;
        this.scene = scene;
